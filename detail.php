...
define('URL', 'https://fern4ndog4rcia-mp-commerce-php.herokuapp.com/');
...
$preference->notification_url = 'http://www.blac.com.ar/notification.php';
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <a class="btn-pagar mercadopago-button" href="<?php echo $preference->init_point; ?>">Pagar la compra</a>
                                </div>
                            </div>
                        </div>
                    </div>
